        ...
        <div class="contents" id="contents">
            <div class="contents-wrap">
                ...
                <section class="prd-detail">
                    ...
                    <button id="done-button" onclick="done()">거래완료</button>
                    <p class="category">
                        여성잡화 ∙<span> 4일전</span>
                    </p>
                    <p class="prd-price">
                        ...
                        <fieldset class="form comment-form">
							...
							<%if (loginUser != null) { %>
								<div class="form-control">
									<textarea name="" id="" cols="" rows="3" title="댓글 입력" placeholder="댓글을 입력해주세요."></textarea>
								</div> 
								<div class="btns-right">
									<button type="button"><em>취소</em></button>
									<button type="button"><em>등록</em></button>
								</div>
							<%} else { %>
								<div class="form-control">
									<textarea name="" id="" cols="" rows="3" title="댓글 입력" placeholder="로그인 후 댓글작성 가능합니다." readonly></textarea>
								</div> 
							<%} %>
						</fieldset>
                    </div>
