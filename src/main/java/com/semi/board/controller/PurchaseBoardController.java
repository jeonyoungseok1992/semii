...
/**
 * Servlet implementation class PurchaseBoardController
 */
@WebServlet("/purchase.bo")
public class PurchaseBoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Board> list = new BoardService().selectThumbnailList(pi);
		
		request.setAttribute("list", list);
		
		request.getRequestDispatcher("views/board/boardByList.jsp").forward(request, response);
	}
